...
public class DetalleFactura implements Serializable {
    ...
    public DetalleFactura(Integer idDetalleFactura, int cantidad, double precio) {
        this.idDetalleFactura = idDetalleFactura;
    ...
    public String toString() {
        return "com.co.factura.modelo.DetalleFactura[ idDetalleFactura=" + idDetalleFactura + " ]";
    }
